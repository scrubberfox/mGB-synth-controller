...
const int cvInputs = 7; // how many analog inputs are used for cv
int cvLevels[cvInputs] = {0, 0, 0, 0, 0, 0, 0};//stores current CV level
int analogInputs[cvInputs] = {A0, A1, A2, A3, A4, A5, A6}; // analog inputs
int midiCCnumbers[cvInputs] = {1, 2, 3, 4, 5, 10, 64}; // define CC# for each CV input
int midiCCvalues[cvInputs] = {0, 0, 0, 0, 0, 0, 0};///stores prev sent CC values
